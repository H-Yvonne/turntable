...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Turntable = __webpack_require__(4);
	(function () {
	    var turntable = '';
	    ...
	    var initTurntable = function initTurntable() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    if (( false ? 'undefined' : _typeof(exports)) === 'object') {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
	    ...
	    var Turntable = function Turntable(config, turnWheel) {
	    ...
	    Turntable.prototype = {
	        ...
	        init: function init(config, turnWheel) {
	            for (var o in config) {
	        ...
	        drawTurntable: function drawTurntable() {
	            this.createElement();
	        ...
	        resizeCanvas: function resizeCanvas() {
	            var width = document.querySelector(this.config.mainWrap).clientWidth,
	        ...
	        adjustRatio: function adjustRatio(ctx) {
	        ...
	        drawWheelCanvas: function drawWheelCanvas() {
	        ...
	        renderTurntableBg: function renderTurntableBg(baseAngle, i) {
	            var angle = this.config.startAngle + i * baseAngle;
	        ...
	        renderTurntableText: function renderTurntableText(baseAngle, i) {
	            var angle = this.config.startAngle + i * baseAngle;
	            this.ctx.fillStyle = 'black';
	            var rewardName = this.turnWheel.rewardNames[i];
	            // const line_height = 17;
	            var translateX = this.size.w * 0.5 + Math.cos(angle + baseAngle / 2) * this.size.textRadius;
	            var translateY = this.size.h * 0.5 + Math.sin(angle + baseAngle / 2) * this.size.textRadius;
	        ...
	        startRotate: function startRotate() {
	            ...
	            var count = this.turnWheel.rewardNames.length;
	        ...
	        rotateFunction: function rotateFunction(item, tip, count) {
	            var self = this;
